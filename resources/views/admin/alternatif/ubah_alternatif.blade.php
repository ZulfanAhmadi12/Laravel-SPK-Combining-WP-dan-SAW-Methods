...
<div class="col-12">
    <div class="card">
        ...
        <h4 class="card-title">Halaman Ubah Alternatif</h4> <br>
        <form method="POST" action="{{ route('update.alternatif') }}">
            @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea id="elm1" name="deskripsi_alternatif">
                        {{ $alternatif->deskripsi_alternatif }}
                    </textarea>
                </div>
            </div>
            <!-- end row -->
            <div class="col-sm-10">
                <input type="submit" class="btn btn-info waves-effect waves-light" value="Update Alternatif">
            </div>
        </form>
        </div>
    </div>
