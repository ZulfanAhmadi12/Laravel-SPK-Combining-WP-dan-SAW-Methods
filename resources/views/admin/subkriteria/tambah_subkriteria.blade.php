...
<div class="col-12">
    <div class="card">
        ...
        <h4 class="card-title">Halaman Tambah Sub-Kriteria</h4> <br>
        <form method="POST" action="{{ route('simpan.subkriteria') }}">
            @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="number" id="bobot_sub" name="bobot_sub" placeholder="Masukkan Nilai Bobot Sub-Kriteria dalam Skala Min: 1 Max: 5">
                    @error('bobot_sub')
                    <span class="text-danger"> {{ $message }}</span>
                    @enderror
                </div>
            ...
            <!-- end row -->
            <div class="col-sm-10">
                <input type="submit" class="btn btn-info waves-effect waves-light" value="Tambah Sub-Kriteria">
            </div>
        </form>
        </div>
    </div>
